...
const Hero = ({ sidebarOnly, contentOnly }: HeroProps) => {
    ...
    if (sidebarOnly) {
        return (
            ...
            >
                ...
                >
                    <Image src={profileImg} alt="Suarau Uthman" className="profile-img-v2" width={400} height={400}/>
                ...
                <div className="social-links-v2">
                    <motion.a whileHover={{ y: -3, color: 'var(--accent-orange)' }} href={socials.behance} target="_blank" rel="noopener noreferrer"><Globe size={18} /></motion.a>
                    <motion.a whileHover={{ y: -3, color: 'var(--accent-orange)' }} href={socials.twitter} target="_blank" rel="noopener noreferrer"><FaXTwitter size={18} /></motion.a>
                    <motion.a whileHover={{ y: -3, color: 'var(--accent-orange)' }} href={socials.instagram} target="_blank" rel="noopener noreferrer"><FaInstagram size={18} /></motion.a>
                </div>
            </motion.div>
        );
    }
